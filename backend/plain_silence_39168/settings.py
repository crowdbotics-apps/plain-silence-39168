"""
Django settings for plain_silence_39168 project.
...
ROOT_URLCONF = 'plain_silence_39168.urls'
...
WSGI_APPLICATION = 'plain_silence_39168.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plain_silence_39168 API",
    "DESCRIPTION": "API documentation for plain_silence_39168 App",
    "VERSION": "v1",
}
